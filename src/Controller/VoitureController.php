...
class VoitureController extends AbstractController
{
    ...
    /**
     * @Route("/ajouter", name="voiture_new", methods={"GET","POST"})
     */
    ...
    /**
     * @Route("/{slug}/modifier", name="voiture_edit", methods={"GET","POST"})
     */
    ...
    /**
     * @Route("/{slug}/supprimer", name="voiture_delete", methods={"POST"})
     */
